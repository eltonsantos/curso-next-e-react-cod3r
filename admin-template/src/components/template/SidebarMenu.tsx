...
export default function SidebarMenu() {
  return (
    <aside className="flex flex-col dark:bg-gray-900 bg-gray-200 text-gray-700">
      ...
      <ul className="">
        <MenuItem onClick={() => console.log("Logout")} text="Sair" icon={LogoutIcon} className="text-red-600 dark:text-red-400 hover:bg-red-400 hover:text-white dark:hover:text-white" />
      </ul>
    </aside>
  )
}
